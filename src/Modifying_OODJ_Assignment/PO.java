...
public class PO {
    ...
    double SupplierPrice;
        ...
        public void View()
    {
            try (FileInputStream file = new FileInputStream("PO.txt");){
            Scanner scanner = new Scanner(file);
            
            System.out.println("\n===========================================================================================");
            System.out.println("POID | UID | ItemID | SupplierID | EstimateDeliveryTime | SupplierPrice | Quantity | Status;");
